...
public class PointJavColor {
    ...
    public PointJavColor(int x, int y, String colour, char symbol) {
    ...
    public PointJavColor() {
        this(0, 0, "black", '*');
    }

    public PointJavColor(int x, int y) {
        this(x, y, "black", '*');
    }

    public PointJavColor(String colour, char symbol) {
        this(0, 0, colour, symbol);
    }

    public PointJavColor(PointJavColor p) {
        x = p.x;
        y = p.y;
        colour = p.colour;
        symbol = p.symbol;
    ...
    public static void main(String[] args) {
        ...
        PointJavColor p1 = new PointJavColor(3, 7, "red", '*');
        //p1.showSimple();
        p1.show();
    }
}
