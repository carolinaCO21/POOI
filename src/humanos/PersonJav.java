...
public class PersonJav {
    ...
    public PersonJav(short yearOfBirth, String name, String surname) {
        /*
        Solución con if
        if(yearOfBirth < 1900){
            yearOfBirth = 1900;
    ...
    public PersonJav(String name, String surname) {
        this((short)2023, name, surname);
    }
    
    public PersonJav(PersonJav p){
    ...
    public boolean compareWith(PersonJav p) {
    ...
    public static void main(String[] args) {
        PersonJav p1 = new PersonJav("Manuel", "Pérez de los Ríos de Guzmal y otras cosas");
        p1.show();
        PersonJav p2 = new PersonJav(p1);
        p1.show();
    }
}
